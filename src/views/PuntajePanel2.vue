<template>
  <div class="container">
    <div class="row tablapuntaje1">
        <div>
            <h1 class="titulo_menu">Tabla de Puntaje de Juego 2</h1>
        </div>
...
export default { 
    ...
    created(){
        ...
        const ListaMejoresJugadoresGameTwoRef = db.collection('puntajeGameTwo').orderBy("division", "desc").limit(5);

        ListaMejoresJugadoresGameTwoRef.get().then((querySnapshot) => {
